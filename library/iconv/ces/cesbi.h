...
#if defined(_ICONV_FROM_ENCODING_UCS_2) || defined(_ICONV_FROM_ENCODING_UCS_2BE) || defined(_ICONV_FROM_ENCODING_UCS_2LE)
#define ICONV_TO_UCS_CES_UCS_2
#endif
#if defined(_ICONV_TO_ENCODING_UCS_2) || defined(_ICONV_TO_ENCODING_UCS_2BE) || defined(_ICONV_TO_ENCODING_UCS_2LE)
...
#if defined(_ICONV_FROM_ENCODING_UCS_4) || defined(_ICONV_FROM_ENCODING_UCS_4BE) || defined(_ICONV_FROM_ENCODING_UCS_4LE)
#define ICONV_TO_UCS_CES_UCS_4
#endif
#if defined(_ICONV_TO_ENCODING_UCS_4) || defined(_ICONV_TO_ENCODING_UCS_4BE) || defined(_ICONV_TO_ENCODING_UCS_4LE)
...
#if defined(_ICONV_FROM_ENCODING_UTF_16) || defined(_ICONV_FROM_ENCODING_UTF_16BE) || defined(_ICONV_FROM_ENCODING_UTF_16LE)
#define ICONV_TO_UCS_CES_UTF_16
#endif
#if defined(_ICONV_TO_ENCODING_UTF_16) || defined(_ICONV_TO_ENCODING_UTF_16BE) || defined(_ICONV_TO_ENCODING_UTF_16LE)
