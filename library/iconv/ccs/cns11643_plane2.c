...
_iconv_ccs_cns11643_plane2 =
{
 ...
 && (defined (TABLE_USE_SIZE_OPTIMIZATION))
	...
	(uint16_t *)&from_ucs_size_cns11643_plane2, /* UCS -> cns11643_plane2 table size-optimized table */
#elif defined (ICONV_FROM_UCS_CCS_CNS11643_PLANE2) \
 && !(defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)&from_ucs_speed_cns11643_plane2, /* UCS -> cns11643_plane2 table speed-optimized table */
#else
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)NULL,
#endif
 ...
 && (defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SIZE_OPTIMIZED,
	(uint16_t *)&to_ucs_size_cns11643_plane2 /* cns11643_plane2 -> UCS table speed-optimized table */
#elif defined (ICONV_TO_UCS_CCS_CNS11643_PLANE2) \
 && !(defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)&to_ucs_speed_cns11643_plane2 /* cns11643_plane2 -> UCS table speed-optimized table */
#else
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)NULL,
#endif
