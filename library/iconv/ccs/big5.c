 ...
 * ======================================================================
 */
#if defined (ICONV_TO_UCS_CCS_BIG5) && !(defined (TABLE_USE_SIZE_OPTIMIZATION))
...
_iconv_ccs_big5 =
{
 ...
 && (defined (TABLE_USE_SIZE_OPTIMIZATION))
	...
	(uint16_t *)&from_ucs_size_big5, /* UCS -> big5 table size-optimized table */
#elif defined (ICONV_FROM_UCS_CCS_BIG5) \
 && !(defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)&from_ucs_speed_big5, /* UCS -> big5 table speed-optimized table */
#else
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)NULL,
#endif
 ...
 && (defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SIZE_OPTIMIZED,
	(uint16_t *)&to_ucs_size_big5 /* big5 -> UCS table speed-optimized table */
#elif defined (ICONV_TO_UCS_CCS_BIG5) \
 && !(defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)&to_ucs_speed_big5 /* big5 -> UCS table speed-optimized table */
#else
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)NULL,
#endif
