...
_iconv_ccs_jis_x0208_1990 =
{
 ...
 && (defined (TABLE_USE_SIZE_OPTIMIZATION))
	...
	(uint16_t *)&from_ucs_size_jis_x0208_1990, /* UCS -> jis_x0208_1990 table size-optimized table */
#elif defined (ICONV_FROM_UCS_CCS_JIS_X0208_1990) \
 && !(defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)&from_ucs_speed_jis_x0208_1990, /* UCS -> jis_x0208_1990 table speed-optimized table */
#else
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)NULL,
#endif
 ...
 && (defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SIZE_OPTIMIZED,
	(uint16_t *)&to_ucs_size_jis_x0208_1990 /* jis_x0208_1990 -> UCS table speed-optimized table */
#elif defined (ICONV_TO_UCS_CCS_JIS_X0208_1990) \
 && !(defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)&to_ucs_speed_jis_x0208_1990 /* jis_x0208_1990 -> UCS table speed-optimized table */
#else
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)NULL,
#endif
