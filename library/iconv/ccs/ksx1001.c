...
_iconv_ccs_ksx1001 =
{
 ...
 && (defined (TABLE_USE_SIZE_OPTIMIZATION))
	...
	(uint16_t *)&from_ucs_size_ksx1001, /* UCS -> ksx1001 table size-optimized table */
#elif defined (ICONV_FROM_UCS_CCS_KSX1001) \
 && !(defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)&from_ucs_speed_ksx1001, /* UCS -> ksx1001 table speed-optimized table */
#else
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)NULL,
#endif
 ...
 && (defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SIZE_OPTIMIZED,
	(uint16_t *)&to_ucs_size_ksx1001 /* ksx1001 -> UCS table speed-optimized table */
#elif defined (ICONV_TO_UCS_CCS_KSX1001) \
 && !(defined (TABLE_USE_SIZE_OPTIMIZATION))
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)&to_ucs_speed_ksx1001 /* ksx1001 -> UCS table speed-optimized table */
#else
	TABLE_SPEED_OPTIMIZED,
	(uint16_t *)NULL,
#endif
