/*
 * $Id: math_kernel_rem_pio2.c,v 1.8 2023-07-18 09:51:53 clib2devs Exp $
*/
...
inline static int kernel_rem_pio2(double *x, double *y, int e0, int nx, int prec, const int *ipio2) {
    ...
    z -= (double) 8.0 * floor(z * (double) 0.125); /* trim off integer >= 8 */
    n = (int) z;
    z -= (double) n;
    ih = 0;
