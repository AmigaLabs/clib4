/*
 * $Id: math_llroundl.c,v 1.0 2022-03-13 12:04:23 clib2devs Exp $
*/
 ...
 */
static const long double dtype_min = LLONG_MIN - 0.5;
static const long double dtype_max = LLONG_MAX + 0.5;
