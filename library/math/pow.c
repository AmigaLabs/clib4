/*
 * $Id: math_pow.c,v 1.11 2021-01-31 12:04:24 clib2devs Exp $
*/
...
static const __float64
        ...
        dp_h[] = {
            _F_64(0.0),
            _F_64(5.84962487220764160156e-01),
        }, /* 0x3FE2B803, 0x40000000 */
        dp_l[] = {
            _F_64(0.0),
            _F_64(1.35003920212974897128e-08),
...
pow(double x, double y) {
    ...
    if (ix > 0x7ff00000 || ((ix == 0x7ff00000) && (lx != 0)) ||
        ...
        return (x + (double) 0.0) + (y + (double) 0.0);
    ...
    if (iy > 0x41e00000) { /* if |y| > 2**31 */
        ...
        w = (t * t) * ((double) 0.5 - t * ((double) 0.3333333333333333333333 - t * (double) 0.25));
