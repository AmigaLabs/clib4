/*
 * $Id: math_e_lgammaf.c,v 1.5 2023-07-19 12:04:23 clib4devs Exp $
 */
...
sin_pif(float x) {
    ...
    switch (n) {
        ...
        case 1:
        case 2:
            y = __kernel_cosdf(pi * ((float) 0.5 - y));
            break;
        case 3:
        case 4:
        ...
        case 5:
        case 6:
            y = -__kernel_cosdf(pi * (y - (float) 1.5));
            break;
        default:
            y = __kernel_sindf(pi * (y - (float) 2.0));
            break;
    }
    return -y;
}
...
__ieee754_lgammaf(float x) {
    ...
    result = __ieee754_lgammaf_r(x, &signgam);
