...
void button_base_constructor(void)
{
    if (ButtonBase != NULL)
    {
...
(*button_base_constructor_ptr)(void) USED = button_base_constructor;

/****************************************************************************/

void button_base_destructor(void)
{
...
(*button_base_destructor_ptr)(void) USED = button_base_destructor;
