...
struct ClassLibrary * DateBrowserBase = NULL;
static struct ClassLibrary * __DateBrowserBase = NULL;
Class * DateBrowserClass = NULL;

/****************************************************************************/

void datebrowser_base_constructor(void)
{
...
(*datebrowser_base_constructor_ptr)(void) USED = datebrowser_base_constructor;

/****************************************************************************/

void datebrowser_base_destructor(void)
{
...
(*datebrowser_base_destructor_ptr)(void) USED = datebrowser_base_destructor;
