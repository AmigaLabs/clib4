...
struct ClassLibrary * GetFontBase = NULL;
static struct ClassLibrary * __GetFontBase = NULL;
Class * GetFontClass = NULL;

/****************************************************************************/

void getfont_base_constructor(void)
{
    if (GetFontBase != NULL)
    {
...
(*getfont_base_constructor_ptr)(void) USED = getfont_base_constructor;

/****************************************************************************/

void getfont_base_destructor(void)
{
...
(*getfont_base_destructor_ptr)(void) USED = getfont_base_destructor;
