...
Clib4Call(posix_spawn, 4340);
Clib4Call(posix_spawnp, 4344);
Clib4Call(posix_spawn_file_actions_init, 4348);
Clib4Call(posix_spawn_file_actions_destroy, 4352);
Clib4Call(posix_spawn_file_actions_addopen, 4356);
Clib4Call(posix_spawn_file_actions_adddup2, 4360);
Clib4Call(posix_spawn_file_actions_addclose, 4364);
Clib4Call(posix_spawn_file_actions_addchdir_np, 4368);
Clib4Call(posix_spawn_file_actions_addfchdir_np, 4372);
Clib4Call(posix_spawnattr_init, 4376);
Clib4Call(posix_spawnattr_destroy, 4380);
Clib4Call(posix_spawnattr_getflags, 4384);
Clib4Call(posix_spawnattr_getpgroup, 4388);
Clib4Call(posix_spawnattr_getschedparam, 4392);
Clib4Call(posix_spawnattr_getschedpolicy, 4396);
Clib4Call(posix_spawnattr_getsigdefault, 4400);
Clib4Call(posix_spawnattr_getsigmask, 4404);
Clib4Call(posix_spawnattr_setflags, 4408);
Clib4Call(posix_spawnattr_setpgroup, 4412);
Clib4Call(posix_spawnattr_setschedparam, 4416);
Clib4Call(posix_spawnattr_setschedpolicy, 4420);
Clib4Call(posix_spawnattr_setsigdefault, 4424);
Clib4Call(posix_spawnattr_setsigmask, 4428);

Clib4Call(waitpid, 4432);