...
#ifdef __SPE__
    SFtype  (* __addsf3) (SFtype a, SFtype b);  /* 4310 */
    DFtype  (* __adddf3) (DFtype a, DFtype b);  /* 4314 */
    DFtype  (* __divdf3) (DFtype a, DFtype b);  /* 4318 */
    SFtype  (* __divsf3) (SFtype a, SFtype b);  /* 4322 */
    TFtype  (* __divtf3) (TFtype a, TFtype b);  /* 4326 */
    CMPtype (* __eqdf2) (DFtype a, DFtype b);   /* 4330 */
    CMPtype (* __eqsf2) (SFtype a, SFtype b);   /* 4334 */
    DFtype  (* __extendsfdf2) (SFtype a);       /* 4338 */
    SItype  (* __fixdfsi) (DFtype a);           /* 4342 */
    SItype  (* __fixsfsi) (SFtype a);           /* 4346 */
    USItype (* __fixunsdfsi) (DFtype a);        /* 4350 */
    USItype (* __fixunssfsi) (SFtype a);        /* 4354 */
    DFtype  (* __floatsidf) (SItype i);         /* 4358 */
    SFtype  (* __floatsisf) (SItype i);         /* 4362 */
    DFtype  (* __floatunsidf) (USItype i);      /* 4366 */
    SFtype  (* __floatunsisf) (USItype i);      /* 4370 */
    CMPtype (* __gesf2) (SFtype a, SFtype b);   /* 4374 */
    CMPtype (* __gedf2) (DFtype a, DFtype b);   /* 4378 */
    CMPtype (* __gtdf2) (DFtype a, DFtype b);   /* 4382 */
    CMPtype (* __gtsf2) (SFtype a, SFtype b);   /* 4386 */
    CMPtype (* __ledf2) (DFtype a, DFtype b);   /* 4390 */
    CMPtype (* __lesf2) (SFtype a, SFtype b);   /* 4394 */
    CMPtype (* __ltdf2) (DFtype a, DFtype b);   /* 4398 */
    CMPtype (* __ltsf2) (SFtype a, SFtype b);   /* 4402 */
    DFtype  (* __muldf3) (DFtype a, DFtype b);  /* 4406 */
    SFtype  (* __mulsf3) (SFtype a, SFtype b);  /* 4410 */
    CMPtype (* __nedf2) (DFtype a, DFtype b);   /* 4414 */
    CMPtype (* __nesf2) (SFtype a, SFtype b);   /* 4418 */
    DFtype  (* __subdf3) (DFtype a, DFtype b);  /* 4422 */
    SFtype  (* __subsf3) (SFtype a, SFtype b);  /* 4426 */
    SFtype  (* __truncdfsf2) (DFtype a);        /* 4430 */
#else
    void *nospe01; /* 4310 */
    void *nospe02; /* 4314 */
    void *nospe03; /* 4318 */
