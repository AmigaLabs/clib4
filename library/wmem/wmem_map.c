...
static bool
wmem_map_reset_cb(wmem_allocator_t *allocator, wmem_cb_event_t event, void *user_data) {
    (void) (allocator);
...
static bool
wmem_map_destroy_cb(wmem_allocator_t *allocator, wmem_cb_event_t event, void *user_data) {
    (void) (allocator);
    (void) (event);
