/*
 * $Id: posix_posix_spawn_file_actions_addchdir_np.c,v 1.0 2024-04-07 12:04:24 clib4devs Exp $
*/
...
int
posix_spawn_file_actions_addfchdir_np(posix_spawn_file_actions_t *__restrict file_actions, int filedes) {
