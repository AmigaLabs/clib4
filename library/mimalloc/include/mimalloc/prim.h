...
static inline void* mi_prim_tls_slot(size_t slot) mi_attr_noexcept {
  ...
  const size_t ofs = (slot*sizeof(void*));
    ...
    #endif
    res = tcb[slot];
  #elif (defined(__APPLE__) && defined(__POWERPC__)) || defined(__amigaos4__) // ppc, issue #781
    MI_UNUSED(ofs);
...
#elif 0 && MI_WIN_USE_FIXED_TLS && !defined(MI_WIN_USE_FLS)
...
#elif defined(__ANDROID__) || defined(__amigaos4__)
  // See issue #381
